...
def get_to_generate_files(last_time):
    ...
    return [os.path.join(OUTPUT_DIR, i) for i in file_names if i.endswith(".json") and int(i.split(".")[0]) > last_time]
...
if __name__ == "__main__":
    ...
    parser.add_argument("nike_refresh_token", help="API refresh access token for nike.com")
    ...
    if new_gpx_files:
        ...
        if len(new_gpx_files) > 10:
            print("too many gpx files to upload, will upload 10, because of the rate limit")
